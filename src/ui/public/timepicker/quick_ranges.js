...
module.constant('quickRanges', [
  ...
  { from: 'now/d',    to: 'now',      display: '今天到目前为止',        section: 0 },
  { from: 'now/w',    to: 'now',      display: '本周到目前为止',          section: 0 },
  { from: 'now/M',    to: 'now',      display: '本月到目前为止',         section: 0 },
  { from: 'now/y',    to: 'now',      display: '今年到目前为止',          section: 0 },

  { from: 'now-1d/d', to: 'now-1d/d', display: '昨天',             section: 1 },
  { from: 'now-2d/d', to: 'now-2d/d', display: '前天',  section: 1 },
  { from: 'now-7d/d', to: 'now-7d/d', display: '上周的同一天',    section: 1 },
  ...
  { from: 'now-6M',   to: 'now',      display: '最近6月',         section: 3 },
